<?php
    ...
    $query = $koneksi->query("SELECT * FROM tbinvoices WHERE status = 0 OR status = 3");
            ...
            <div class="col-12">
                <div class="section">
                    <h2 class="title_section d-flex">
                        ...
                        <div class="w-50 text-right float-right">
                            <span style="font-size: 11px">
                                <i class="fa fa-circle text-danger"></i> dibatalkan | <i
                                    class="fa fa-circle text-success"></i> pesanan sampai
                            </span>
                        </div>
                    </h2>
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            if ($query->num_rows > 0) {
                                do {
                                    $batal = ($row['status'] == 3) ? 'bg-danger text-light' : "bg-success text-light";
                                    // CEK CLIENT
